...
transactionRouter.post(
  ...
  async (req, res) => {
    try {
      ...
      await db.insertInto("Transaction").values(transaction).execute();
...
transactionRouter.get(
  ...
  async (req, res) => {
    try {
      var transactions =  db.selectFrom("Transaction").selectAll();
      transactions=addFiltration("Transaction",transactions as any,req);
      paginatedResults(transactions as any, req, res);
